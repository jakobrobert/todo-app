...
def get_long_term_todo_duration_overview(id):
    ...
    """
    average_daily_duration_all_days = long_term_todo_overview.get_average_daily_duration_all_days()
    average_daily_duration_active_days = long_term_todo_overview.get_average_daily_duration_active_days()
