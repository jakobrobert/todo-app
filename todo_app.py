...
def __get_summary_for_long_term_todo_statistics(statistics, progress_goal):
    ...
    remaining_progress_percents = Utils.convert_to_percents(remaining_progress, statistics.progress_goal)
    ...
    return {
        ...
        "active_days_percents": active_days_percents,  # TODO rename to "_in_percents"
        "remaining_progress": remaining_progress,
        "remaining_progress_in_percents": remaining_progress_percents,
